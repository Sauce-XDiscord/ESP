...
local options = {
    ...
    -- headshot odds
    headshot_chance = 1, -- odds for aiming on the head in percentage, 0 = no head (lol) and 100 = always head
    ...
    -- rainbow settings
    rainbow = true,
    rainbow_speed = 7, -- lower is faster, 0.000001 is the lowest you can go
